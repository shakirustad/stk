...
$config = array(
    ...
    "key"              => "2MzGGcWamcsaCcK4pdMR6L3ghIPgkjRC", //Enter your consumer key here
    "secret"           => "zYTbBQJpgKaHlSjq", //Enter your consumer secret here
    "username"         => "apitest",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919", //Enter your passkey here
    "CallBackURL"      => "https://0ce1-41-60-238-102.in.ngrok.io/mpesa/one/callback.php", //When using localhost, Use Ngrok to forward the response to your Localhost
    "AccountReference" => "CompanyXLTD",
    "TransactionDesc"  => "Payment of DemoX" ,
);

// $consumerKey = '2MzGGcWamcsaCcK4pdMR6L3ghIPgkjRC'; //Fill with your app Consumer Key
// $consumerSecret = 'zYTbBQJpgKaHlSjq'; // Fill with your app Secret
